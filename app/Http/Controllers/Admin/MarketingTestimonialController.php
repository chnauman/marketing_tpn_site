...
class MarketingTestimonialController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.marketingTestimonials.index', compact('marketingTestimonials'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.marketingTestimonials.create');
    }
    ...
    public function store(StoreMarketingTestimonialRequest $request)
    {
        ...
        return redirect()->route('admin.marketing-testimonials.index');
    }
    ...
    public function edit(MarketingTestimonial $marketingTestimonial)
    {
        ...
        return view('admin.marketingTestimonials.edit', compact('marketingTestimonial'));
    }
    ...
    public function show(MarketingTestimonial $marketingTestimonial)
    {
        ...
        return view('admin.marketingTestimonials.show', compact('marketingTestimonial'));
    }
