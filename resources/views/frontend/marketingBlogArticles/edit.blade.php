    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.marketing-blog-articles.update", [$marketingBlogArticle->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.marketingBlogArticle.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $marketingBlogArticle->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="author" id="author" value="{{ old('author', $marketingBlogArticle->author) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="duration" id="duration" value="{{ old('duration', $marketingBlogArticle->duration) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="article_text" id="article_text">{!! old('article_text', $marketingBlogArticle->article_text) !!}</textarea>
