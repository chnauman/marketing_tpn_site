...
<header>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="https://demos.farrukhwaseem.com/print-nation/#"><img src="{{ asset('images/logo.svg') }}" width="250" alt="The Print Nation" class="img-fluid"></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <a class="nav-link" aria-current="page" href="https://demos.farrukhwaseem.com/print-nation/#">Catalog</a>
                    <a class="nav-link" href="https://demos.farrukhwaseem.com/print-nation/#">How it Works</a>
                    <a class="nav-link" href="https://demos.farrukhwaseem.com/print-nation/#">FAQs</a>
                    <a class="nav-link" href="https://demos.farrukhwaseem.com/print-nation/#">Blog</a>
                    <a class="nav-link" href="https://demos.farrukhwaseem.com/print-nation/#">Help</a>
                </div>
                <div class="login-btn">
